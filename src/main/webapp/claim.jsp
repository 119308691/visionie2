...
<div id="accordion">
    ...
    <div class="card card-default">
        <div class="card-header">
                  ...
                  <h3 style="color:Black;">CLAIM FOR PAYMENT - ${SKUSER.name}</h3>
...
Findi, T. (2021) “IS3312 – Web Development Assignment (Kitstop Version 1.0) [Source code]. -->
 ...
 document.getElementById("date").value = datestring;
                            ...
                            <div class="form-group row">
                                <label for="optician_ID" class="col-4 col-form-label">Optician Panel No.</label> 
                                <div class="col-8">
                                    <input id="optician_ID" name="optician_ID" type="number" class="form-control" required="required" value="${SKUSER.panelNO}" readonly>
                                </div>
                            </div>
