                  ...
                  <div class="container" ">
                    <div class="row">
                        ...
                        <div id="test" class="table-responsive">
                            <h7 style="color: black;"> Search by Status <b>or</b> PPSN:</h7>
                            <br>
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Status">
                 <input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by PPSN">
            <table id="results" class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="${editApplicationUrl}"> Edit</a> </td>
                                </tr>
                                </c:forEach>
                                <tr>
                                    <td></td>
                                    ...
                                    <c:url value="/Application" var="addApplicationUrl">
                                        <c:param name="action" value="add"/>
                                    </c:url>
                                    <td><a href="${addApplicationUrl}" > Add </a></td>
