...
<html>
    <head>
        ...
        <title>Admin Home - Queries</title>
         <!-- Bootstrap icons-->
...
<!-- creating form -->
                    <div class="row">
                       <c:url value="/Query" var="updateQueryUrl">
                                        <c:param name="action" value="updateCompleteQuery"/>
                                    </c:url>

                        <form action="${updateQueryUrl}" method="POST">
                            <input id="id" name="id" type="hidden" value="${oldQuery.id}">
                             <div class="form-group row">
                                <label for="PPSN" class="col-4 col-form-label">PPSN</label> 
                                <div class="col-8">
                                    <input id="PPSN" name="PPSN" type="text" value="${oldQuery.PPSN}" class="form-control" readonly >
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="subject" class="col-4 col-form-label">Subject</label> 
                                <div class="col-8">
                                    <input id="subject" name="subject" type="text" value="${oldQuery.subject}" class="form-control" readonly>
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="question" class="col-4 col-form-label">Question</label> 
                                <div class="col-8">
                                    <input id="question" name="question" type="text" value="${oldQuery.question}" class="form-control" readonly>
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="answer" class="col-4 col-form-label">Answer</label> 
                                <div class="col-8">
                                    <input id="answer" name="answer" type="text" value="${oldQuery.answer}" class="form-control" required="required" readonly>
                                </div>
                            </div>
                              <div class="form-group row">
                                <label for="status" class="col-4 col-form-label">Status</label> 
                                <div class="col-8">
                                    <input id="status" name="status" type="text" value="${oldQuery.status}" class="form-control" required="required" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="offset-4 col-8">
                                  ...
                                  <button class="btn" style="background-color:#006355; color:white" onclick="history.back()">Back</button>
                                </div>
                            </div>
                        </form> 
