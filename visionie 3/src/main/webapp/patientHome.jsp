                    ...
                    <div class="col-lg-6 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                ...
                                <a href="Treatment?action=listTreatments2"> <h2 class="fs-4 fw-bold" style="color: black">View Treatment History</h2></a>
                        
                                <p class="mb-0">View Treatment History. Here you can view Treatment History for patients.</p>
                            </div>
                        </div>
                    </div>
                </div>
