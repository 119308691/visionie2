...
<div id="accordion">
    ...
    <div class="card card-default">
        <div class="card-header">
                  ...
                  <h3 style="color:Black;">ADD TREATMENT </h3>
...
Findi, T. (2021) “IS3312 – Web Development Assignment (Kitstop Version 1.0) [Source code]. -->
                        ...
                        <c:url value="/Treatment" var="insertTreatmentUrl">
                            <!-- adding paramater -->
                                        <c:param name="action" value="insertTreatment"/>
                                    </c:url>
                            <!-- setting form submission to url -->
                        <form action="${insertTreatmentUrl}" method="POST">
                            <!-- creating form -->
                            ...
                            <div class="form-group row">
                                <label for="patient" class="col-4 col-form-label">Patient Name</label> 
                                <div class="col-8">
                                    <input id="patient" name="patient" type="text" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="ppsn" class="col-4 col-form-label">PPSN</label> 
                                <div class="col-8">
                                    <input type="ppsn" id="DOB" name="ppsn" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="details" name="details" type="text" class="form-control" required="required">
                                </div>
                            </div><!-- comment -->
                            <div class="form-group row">
                                <label for="optician" class="col-4 col-form-label">Optician</label> 
                                <div class="col-8">
                                    <input id="optician" name="optician" type="optician" class="form-control" value="${SKUSER.name}" required="required" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="offset-4 col-8">
                                    ...
                                    <button name="submit" onclick="myFunction()" type="submit" class="btn" style="background-color:#006355; color:white">Submit</button>
		...
		<script>
function myFunction() {
  alert("This Treatment History has been submitted succesfully.");
}
</script>
