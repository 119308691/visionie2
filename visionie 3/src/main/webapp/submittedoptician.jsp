		...
		<div class="row">
			<div class="col-lg-6 offset-lg-3 col-12">
				...
				<div class="success-inner">
					...
					<p> An Administrator will review your query and respond as soon as possible. <br> You can view your submitted queries and their status' from the query portal of your account. </p>
					<a href="opticianHome.jsp" class="btn btn-lg" style="background-color:#006355; color:white">Go to Optician Portal</a>
