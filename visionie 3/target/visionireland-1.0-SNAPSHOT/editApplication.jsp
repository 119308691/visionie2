    ...
    <div class="card card-default">
        ...
        <div class="panel-body inf-content">
                 ...
                 <div class="container">
                    ...
                    <h4 class="my-4">Edit Application Details</h4>
...
Findi, T. (2021) “IS3312 – Web Development Assignment (Kitstop Version 1.0) [Source code]. -->
                    ...
                    <div class="row">
                       ...
                       <c:url value="/Application" var="updateApplicationUrl">
                                        <c:param name="action" value="updateCompleteApplication"/>
                                    </c:url>

                        <form action="${updateApplicationUrl}" method="POST">
                            <input id="id" name="id" type="hidden" value="${oldApplication.id}">
                             <div class="form-group row">
                                <label for="date" class="col-4 col-form-label">Date</label> 
                                <div class="col-8">
                                    <input id="date" name="date" type="text" value="${oldApplication.date}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="fName" class="col-4 col-form-label">First Name</label> 
                                <div class="col-8">
                                    <input id="firstName" name="fName" type="text" value="${oldApplication.firstName}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="lName" class="col-4 col-form-label">Last Name</label> 
                                <div class="col-8">
                                    <input id="lastName" name="lName" type="text" value="${oldApplication.lastName}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="DOB" class="col-4 col-form-label">DOB</label> 
                                <div class="col-8">
                                    <input id="DOB" name="DOB" type="text" value="${oldApplication.DOB}" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="PPSN" name="PPSN" type="text" value="${oldApplication.PPSN}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="medNo" class="col-4 col-form-label">Medical Card No.</label> 
                                <div class="col-8">
                                    <input id="medNo" name="medNo" type="text" value="${oldApplication.medNo}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="expiry" class="col-4 col-form-label">Expiry</label> 
                                <div class="col-8">
                                    <input id="expiry" name="expiry" type="text" value="${oldApplication.expiry}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="phone" class="col-4 col-form-label">Phone No:</label> 
                                <div class="col-8">
                                    <input id="phone" name="phone" type="text" value="${oldApplication.phone}" class="form-control" required="required">
                                </div>
                            </div>
                                ...
                                <div class="col-8">
                                    <input id="address" name="address" type="text" value="${oldApplication.address}" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="examination" class="col-4 col-form-label">Eye Examination Required?</label> 
                                <div class="col-8">
                                    <input id="examination" name="examination" type="text" value="${oldApplication.examination}" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="examdate" name="examdate" type="text" value="${oldApplication.examdate}" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="optician" name="optician" type="text" value="${oldApplication.optician}" class="form-control" required="required">
                                </div>
                            </div>
                                ...
                                <div class="col-8">
                                    <select name="status" id="status" value="${oldApplication.status}" class="form-control" required="required">
                                  ...
                                  <!--  <input id="status" name="status" type="text" value="${oldApplication.status}" class="form-control" required="required"> -->
                                </div>
                            </div>
