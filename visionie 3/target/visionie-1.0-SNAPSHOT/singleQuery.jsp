        ...
        <div class="panel-body inf-content">
                  ...
                  <div class="container" ">
                    <div class="row">
                        ...
                        <% query currentquery= (query)request.getAttribute("REQUEST_query");%>
            ...
            <table id="results" class="table table-striped">
                            <thead style="background-color:#006355; color:white;">
                                <tr>
                                    ...
                                    <th scope="col">Question</th><!-- comment -->
                            ...
                            <tbody>
                                <!-- calling actions from the servlet 
                                   ...
                                   <c:url value="/singleQueryServlet" var="deleteQueryUrl">
                                        <c:param name="action" value="deleteQuery"/>
                                ...
                                <tr>
                                    ...
                                    <td scope="row"><%=currentquery.getId()%></td>
                                   
                                    <td><%=currentquery.getSubject()%></td>
                                    <td><%=currentquery.getQuestion()%></td>
                                    <td><%=currentquery.getAnswer()%></td>
                                   <td><%=currentquery.getStatus()%></td>
