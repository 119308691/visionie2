...
<div id="accordion">
    ...
    <div class="card card-default">
        <div class="card-header">
                  ...
                  <h3 style="color:Black;">ADD OPTICIAN </h3>
...
Findi, T. (2021) “IS3312 – Web Development Assignment (Kitstop Version 1.0) [Source code]. -->
                        ...
                        <c:url value="/Optician" var="insertOpticianUrl">
                            <!-- adding paramater -->
                                        <c:param name="action" value="insertOptician"/>
                                    </c:url>
                            <!-- setting form submission to url -->
                        <form action="${insertOpticianUrl}" method="POST">
                            <!-- creating form -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="panelNO" name="panelNO" type="text" class="form-control" required="required">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input type="address" id="DOB" name="address" class="form-control" required="required">
                                </div>
                            </div>
