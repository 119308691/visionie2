...
<!-- creating form -->
                    <div class="row">
                       <c:url value="/submitClaim" var="updateopticianclaimUrl">
                                        <c:param name="action" value="updateCompleteopticianclaim"/>
                                    </c:url>

                        <form action="${updateopticianclaimUrl}" method="POST">
                            <input id="id" name="id" type="hidden" value="${oldopticianclaim.id}">
                            
                             <div class="form-group row">
                                <label for="date" class="col-4 col-form-label">Date</label> 
                                <div class="col-8">
                                    <input id="date" name="date" type="text" value="${oldopticianclaim.date}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="prescription" class="col-4 col-form-label">Prescription</label> 
                                <div class="col-8">
                                    <input id="prescription" name="prescription" type="text" value="${oldopticianclaim.prescription}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="glassesRequired" class="col-4 col-form-label">Were glasses required?</label> 
                                <div class="col-8">
                                    <input id="glassesRequired" name="glassesRequired" type="text" value="${oldopticianclaim.glassesRequired}" class="form-control" required="required">
                                </div>
                            </div>
                             <div class="form-group row">
                                <label for="lenses" class="col-4 col-form-label">Was there a change in lenses?</label> 
                                <div class="col-8">
                                    <input id="lenses" name="lenses" type="text" value="${oldopticianclaim.lenses}" class="form-control" required="required">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="comments" name="comments" type="text" value="${oldopticianclaim.comments}" class="form-control" required="required">
                                </div>
                            </div>
                                ...
                                <div class="col-8">
                                    <input id="details" name="details" type="text" value="${oldopticianclaim.details}" class="form-control" required="required">
                                </div>
                            </div>
                               <div class="form-group row">
                                <label for="examiner" class="col-4 col-form-label">Optical Examiner/Dispenser</label> 
                                <div class="col-8">
                                    <input id="examiner" name="examiner" type="text" value="${oldopticianclaim.examiner}" class="form-control" required="required">
                                </div>
                            </div>
                                
                                 <div class="form-group row">
                                <label for="opticianID" class="col-4 col-form-label">Optician ID.</label> 
                                <div class="col-8">
                                    <input id="optician_ID" name="opticianID" type="text" value="${oldopticianclaim.opticianID}" class="form-control" required="required">
                                </div>
                            </div>
                               ...
                               <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="PPSN" name="PPSN" type="text" value="${oldopticianclaim.PPSN}" class="form-control" required="required">
                                </div>
                            </div>
                                ...
                                <div class="col-8">
                                    ...
                                    <select name="status" id="status" value="${oldopticianclaim.status}" class="form-control" required="required">
