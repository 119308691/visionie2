...
<head>
 ...
 <meta charset="utf-8" />
        ...
        <!-- title of web page -->
        <title>VisionIreland Login</title>
        <!-- Favicon-->
...
<div class="form-group">
    <br>
            ...
            <form class="form-signin" action="/visionie/patientLogin" method="post">
              ...
              <button class="btn" style="background-color:#006355; color:white" method="post" type="submit">Login</button>
              <hr class="my-4">
