    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center">
                ...
                <h4 style="color: #006355;"> View Applications </h4>
        ...
        <div class="panel-body inf-content">
                  ...
                  <div class="container" ">
                    <div class="row">
                        ...
                        <% application currentapplication = (application)request.getAttribute("REQUEST_application");%>
                        <div id="test" class="table-responsive">
                              <h6 style="color: black;"> NAME: ${SKUSER.firstName} ${SKUSER.lastName} - PPSN: ${SKUSER.PPSN}</h6>
            ...
            <table id="results" class="table table-striped">
                            ...
                            <tbody>
                                <!-- calling actions from the servlet 
                                   ...
                                   <c:url value="/singleApplicationServlet" var="deleteApplicationUrl">
                                        <c:param name="action" value="deleteApplication"/>
                                        <c:param name="PPSN" value="'${SKUSER.PPSN}'"/>
                                    </c:url> -->
                                     
                                    
                                <tr>
                                    <!-- retrieving data from db -->
                                    <td scope="row"><%=currentapplication.getId()%></th>
                                   
                                    <td><%=currentapplication.getDate()%></td>
                                    <td><%=currentapplication.getStatus()%></td>
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <!-- calling add action from the servlet -->
