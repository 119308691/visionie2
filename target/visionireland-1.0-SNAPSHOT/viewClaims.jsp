    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center">
                ...
                <h4 style="color: #006355;"> View Claims</h4>
            </div>
        </div>
    </div>
    <br>
    <div class="card card-default">
        ...
        <div class="panel-body inf-content">
            ...
            <div class="table-responsive">
                     <h7 style="color: black;"> Search by Status <b>or</b> ID:</h7>
                            <br>
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Status">
                 <input type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by ID">
            <table id="results" class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${opticianclaims}" var="opticianclaim">
                                    <c:url value="/submitClaim" var="editopticianclaimUrl">
                                        <c:param name="action" value="edit"/>
                                        <c:param name="id" value="${opticianclaim.id}"/>
                                    </c:url>
                                    
                                <tr>
                                    <td scope="row">${opticianclaim.id}</th>
                                    <td>${opticianclaim.opticianID}</td>
                                   
                                    <td>${opticianclaim.status}</td>
                                    <td><a href="${editopticianclaimUrl}"> View Claim</a> </td>
                                </tr>
                                </c:forEach>
                                <tr>
                                    <td></td>
