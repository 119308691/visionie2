                        ...
                        <form action="${updateQueryUrl}" method="POST">
                            <input id="id" name="id" type="hidden" value="${oldQuery.id}">
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <input id="answer" name="answer" type="text" value="${oldQuery.answer}" class="form-control" required="required">
                                </div>
                            </div>
                             ...
                             <div class="form-group row">
                                ...
                                <div class="col-8">
                                    <select name="status" id="status" value="${oldQuery.status}" class="form-control" required="required">
