                    ...
                    <div class="col-lg-6 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                ...
                                <h2 class="fs-4 fw-bold">View Queries</h2>
                    ...
                    <div class="col-lg-6 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                ...
                                <h2 class="fs-4 fw-bold">Submit Query</h2>
                    ...
                    <div class="col-lg-6 col-xxl-4 mb-5">
                        <div class="card bg-light border-0 h-100">
                            <div class="card-body text-center p-4 p-lg-5 pt-0 pt-lg-0">
                                ...
                                <a href="information.jsp"> <h2 class="fs-4 fw-bold" style="color: black">View FAQ</h2></a>
                               
                                <p class="mb-0">View FAQ. Here you can view up to date information on the scheme.</p>
                            </div>
                        </div>
                    </div>
                </div>
