    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="text-center">
                ...
                <h4 style="color: #006355;"> View Opticians</h4>
            </div>
        </div>
    </div>
    <br>
    <div class="card card-default">
        ...
        <div class="panel-body inf-content">
            ...
            <table class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${opticians}" var="optician">
                                    <c:url value="/Optician" var="editOpticianUrl">
                                        <c:param name="action" value="edit"/>
                                        <c:param name="id" value="${optician.id}"/>
                                    </c:url>
                                    
                                <tr>
                                    <td scope="row">${optician.id}</th>
                                    <td>${optician.panelNO}</td>
                                    <td>${optician.name}</td>
                                    <td>${optician.address}</td>
                                    <td>${optician.telephone}</td>
                                    <td>${optician.email}</td>
                                    <td><a href="${editOpticianUrl}">Edit</a></td>
                                </tr>
                                </c:forEach>
                                <tr>
                                    <td></td>
                                    ...
                                    <td></td><!-- comment -->
                                    <td></td>
                                    <c:url value="/Optician" var="addOpticianUrl">
                                        <c:param name="action" value="add"/>
                                    </c:url>
                                    <td><a href="${addOpticianUrl}" > Add </a></td>
