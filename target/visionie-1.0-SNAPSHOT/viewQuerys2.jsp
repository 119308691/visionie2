    ...
    <div class="card card-default">
        ...
        <div class="panel-body inf-content">
            ...
            <div class="table-responsive">
                <h5 style="color: black;"> ${SKUSER.panelNO} <b>-</b> ${SKUSER.name} </h5>
                            <br>
           
                            <input hidden type="text" id="myInput1" onkeyup="myFunction1()" placeholder="Search by PPSN" value="${SKUSER.panelNO}" readonly>
            <table id="results" class="table table-striped">
                            ...
                            <tbody>
                                <c:forEach items="${optquerys}" var="query">
